...
def _print_instructions(output_mp4):
    print("""
╔══════════════════════════════════════════════════════════════╗
║  RESOLVE IS OPENING — FOLLOW THESE STEPS:                   ║
╠══════════════════════════════════════════════════════════════╣
║                                                              ║
║  1. Wait for DaVinci Resolve to finish loading               ║
║                                                              ║
║  2. In the menu bar, click:                                  ║
║     Workspace  →  Scripts  →  MoFA_Render                   ║
║                                                              ║
║  3. The script will run automatically:                       ║
║     - Import your modified .comp                             ║
...
║     {output}
║                                                              ║
║  Watch the Console (Workspace → Console) for progress.       ║
╚══════════════════════════════════════════════════════════════╝
""".format(output=output_mp4[:55].ljust(55)))